...
Version:            1.18.2b
Release:            1%{?dist}
Summary:            Zen is a firefox-based browser with the aim of pushing your productivity to a new level!
...
%__install -d %{buildroot}{/opt/%{full_name}/distribution,%{_bindir},%{_datadir}/applications,%{_datadir}/icons/hicolor/128x128/apps,%{_datadir}/icons/hicolor/64x64/apps,%{_datadir}/icons/hicolor/48x48/apps,%{_datadir}/icons/hicolor/32x32/apps,%{_datadir}/icons/hicolor/16x16/apps}
...
patchelf --set-rpath '$ORIGIN' %{buildroot}/opt/%{full_name}/libonnxruntime.so
